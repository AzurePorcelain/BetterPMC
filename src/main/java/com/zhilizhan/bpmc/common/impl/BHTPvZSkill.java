...
public class BHTPvZSkill extends SkillTypes {
    ...
    public static final ISkillType GRASS_CARP_HEAL_SPEED = new SkillType("grass_carp_heal_speed", ArrayUtil.getAverageArray(3, 2.0F, 0.5F), Arrays.asList(5,7));
    ...
    public static int getSkillLevel(ItemStack stack, ISkillType type) {
        if (stack.getOrCreateTag().contains("paz_skill_tag")) {
            CompoundNBT tmp = stack.getOrCreateTag().getCompound("paz_skill_tag");

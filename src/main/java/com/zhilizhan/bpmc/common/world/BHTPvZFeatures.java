...
public class BHTPvZFeatures {
    ...
    public static final ConfiguredFeature<?, ?> PATCH_SQUASH = register("patch_squash", Feature.RANDOM_PATCH.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider((BHTPvZBlocks.SQUASH.get()).defaultBlockState()), new SimpleBlockPlacer())).tries(32).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).noProjection().build()).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).chance(8)); // 窝瓜生成
